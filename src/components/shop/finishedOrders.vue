<template>
  <div id="showOrders" class="col">
      <div class="col titleOfComponent text-center" @click="hideComponent = !hideComponent"><h3>ORDERS: ARCHIVE</h3></div>
      <transition enter-active-class="animated zoomIn" leave-active-class="animated zoomOut">
    <div class="col extramarginbottom" v-show="hideComponent">
      <div class="col">
        <button class="btn btn-dark" @click="refreshFinishedOrders()">Refresh</button>
      </div>
      <div class="col text-uppercase orderBox">
        <div v-for="(o,i) in finishedOrders" :key="i">
          ...
          <div class="row" v-show="o.hideDetails">
            <div class="col-4 contentBox" >
              ...
              <div class="col font-weight-bold">
                ...
                <form @submit.prevent="updateOrderStatusForFinishedOreders(o.orderNumber, o.orderPaid, o.orderCompleted, o.orderSent)">
